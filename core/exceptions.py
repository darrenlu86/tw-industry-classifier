...
────────────
  ...
  PERIPHERAL     政府周邊單位白名單（**本檔內建，因為都是法定公開機構**）
...
# ══════════════════════════════════════════════════════════════════════════
PERIPHERAL = {
    "03559508": "臺灣證券交易所股份有限公司",
    "23474232": "臺灣集中保管結算所股份有限公司",
    "16092130": "臺灣期貨交易所股份有限公司",
    "92002238": "財團法人中華民國證券櫃檯買賣中心",
    "15639870": "財團法人台灣票據交換所",
    "00999340": "財團法人金融聯合徵信中心",
    "29188566": "臺灣碳權交易所股份有限公司",
}
...
def load(path=None):
    ...
    # 本地檔也可以追加周邊單位（例如你的組織把某個公設機構視為周邊單位）
    for tid, name in (data.get("peripheral_extra") or {}).items():
        PERIPHERAL[str(tid)] = name
    _loaded_from = p
    return p
